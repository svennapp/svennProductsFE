...
export const API_ROUTES = {
  ...
  warehouseScripts: (warehouseId: number) => `${API_BASE_URL}/api/warehouses/${warehouseId}/scripts`,
  ...
  scriptLogs: (scriptId: number) => 
    `${API_BASE_URL}/api/jobs/scripts/${scriptId}/logs`,
} as const
